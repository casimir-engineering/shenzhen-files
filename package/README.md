...
| `make-icon.sh` | Regenerates `AppIcon.icns` + `dmg-logo.png` from the approved transparent `AppIcon-source-v4.png` folder foreground. macOS supplies the native outer enclosure, avoiding a double-squircle Dock icon. |
