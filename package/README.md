...
| `make-icon.sh` | Regenerates `AppIcon.icns` + `dmg-logo.png` from the folder-first Shenzhen Files mark (`make-logo.swift`), with a small 深圳 signature that stays secondary at Dock sizes. |
