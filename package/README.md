...
| `make-icon.sh` | Regenerates `AppIcon.icns` + `dmg-logo.png` from the approved transparent `AppIcon-source-v5.png` folder foreground. macOS supplies the native frosted outer enclosure, avoiding a double-squircle Dock icon. |
